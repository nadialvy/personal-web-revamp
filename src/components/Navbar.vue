    ...
    <div class="block lg:hidden">
      ...
      <div class="bg-white w-80 h-full fixed z-50 px-8 py-4 transition-all ease-in" :class="isDrawerOpen ? 'visible-canvas' : 'hidden-canvas'">
        <div class="flex flex-col gap-y-2 text-black">
          ...
          <p @click="toggleDrawer" class="hover:cursor-pointer hover:bg-purple-500 p-4 rounded-md hover:bg-opacity-90 hover:text-white transition-all"><a href="#about">About</a></p>
          <p @click="toggleDrawer" class="hover:cursor-pointer hover:bg-purple-500 p-4 rounded-md hover:bg-opacity-90 hover:text-white transition-all"><a href="/#skills">Skills</a></p>
          <p @click="toggleDrawer" class="hover:cursor-pointer hover:bg-purple-500 p-4 rounded-md hover:bg-opacity-90 hover:text-white transition-all"><a href="/#projects">Projects</a> </p>
          <p @click="toggleDrawer" class="hover:cursor-pointer hover:bg-purple-500 p-4 rounded-md hover:bg-opacity-90 hover:text-white transition-all"><a href="/#experiences">Experiences</a></p>
          <p @click="toggleDrawer" class="hover:cursor-pointer hover:bg-purple-500 p-4 rounded-md hover:bg-opacity-90 hover:text-white transition-all"><a href="/#contact">Contact</a></p>
        </div>
      </div>
    </div>
          ...
          <div class="flex items-center justify-between px-16 py-8">
            ...
            <div class="w-8/10">
              <div class="flex gap-x-12 xl:gap-x-20 2xl:gap-x-40 text-white font-semibold text-md xl:text-lg hover:cursor-pointer">
                <p class="hover:text-pink-700 hover:underline hover:underline-offset-8 transition-all"><a href="#about">About</a></p>
                <p class="hover:text-pink-700 hover:underline hover:underline-offset-8 transition-all"><a href="/#skills">Skills</a></p>
                <p class="hover:text-pink-700 hover:underline hover:underline-offset-8 transition-all"><a href="/#projects">Projects</a></p>
                <p class="hover:text-pink-700 hover:underline hover:underline-offset-8 transition-all"><a href="/#experiences">Experiences</a></p>
              </div>
            </div>
            <div class="w-1/10">
              <a href="/#contact">
                <button class="border border-white py-1 px-4 text-white font-semibold hover:bg-pink-700 hover:border-pink-700">Contact</button>
              </a>
            </div>
          </div>
        </nav>
