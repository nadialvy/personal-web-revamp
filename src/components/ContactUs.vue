<template>
  <p class="relative bottom-[68px] lg:bottom-[98px] bg-white" id="contact"></p>
  <div class="py-6 px-8 lg:px-20 lg:py-8 xl:px-28 xl:py-10 2xl:px-[410px] 2xl:py-12 relative mb-10">
    ...
    <div class="lg:flex lg:gap-x-24">
      ...
      <div class="lg:w-1/2">
        ...
        <button class="btn btn-primary mt-4 rounded-none w-full mb-2 lg:text-lg" @click="sendEmail">Send</button>
      </div>
    </div>
