    ...
    <div class="lg:flex lg:gap-x-24">
      ...
      <div class="lg:w-1/2">
        <div class="form-control w-full mb-2 z-20">
          ...
          <input type="text" v-model="from_name" name="name" placeholder="John Doe" class="bg-white text-black input input-bordered w-full mb-2" />
        </div>
        <div class="form-control w-full mb-2">
          <label class="label">
            <span class="label-text lg:text-lg">Email</span>
          </label>
          <input type="text" placeholder="john@gmail.com" v-model="from_email" name="email" class="bg-white text-black input input-bordered w-full mb-2" />
        </div>
        <div class="form-control w-full mb-2">
          <label class="label">
            <span class="label-text lg:text-lg">Subject</span>
          </label>
          <input type="text" v-model="subject" name="subject" class="bg-white text-black input input-bordered w-full mb-2" />
        </div>
        <div class="form-control">
          <label class="label">
            <span class="label-text lg:text-lg">Message</span>
          </label>
          <textarea v-model="message" name="message" class="bg-white text-black textarea textarea-bordered h-24" ></textarea>
        </div>
